...
پس از نمایش هر نتیجه، ربات مزایای مشاوره رایگان و دستور `/moshavere` را معرفی می‌کند. این دستور در صورت نیاز شماره متعلق به خود کاربر را دریافت می‌کند و درخواست را بدون فرم اضافه ثبت می‌کند. درخواست همراه آخرین نتیجه تخمین در PostgreSQL ثبت و برای تمام مدیران `CONTACT_ADMIN_CHAT_IDS` ارسال می‌شود.
